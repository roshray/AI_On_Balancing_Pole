# -*- coding: utf-8 -*-
"""
Created on Thu Jun 22 19:34:14 2017
...
def train_model(training_data,model=False):
	...
	model.fit({'input':X},{'targets':y}, n_epoch=3, snapshot_step=500, show_metric=True,run_id='openaiBacchu')
	return model 
training_data = intial_population()
model= train_model(training_data)

model.save('modelsaved7.model')

#model.load('modelsaved.model')
